...
export default async function DashboardPage({
  ...
  // Check if we have any email connections for this workspace
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <p className="mt-2 text-lg text-zinc-600 dark:text-zinc-400">
            AI-powered assistant for dental clinics
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
              AI handles patient calls and emails, books appointments automatically
            </p>
          </div>
          <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
            <h3 className="font-semibold text-zinc-900 dark:text-zinc-50">
            ...
            <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
              Voice-to-notes during and after appointments, hands-free charting
            </p>
          </div>
          <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
            <h3 className="font-semibold text-zinc-900 dark:text-zinc-50">
            ...
            <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
              Structured clinical notes ready for your practice management system
            </p>
          </div>
        </div>
      </div>
